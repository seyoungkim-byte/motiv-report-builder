...
[★ 브랜드 익명화]
차트의 title / subtitle / caption / label 등 **출력 모든 텍스트에 실제 광고주명·
경쟁사명·브랜드명·제품명을 사용하지 마세요.** 입력에서 발견되는 고유명사는
"광고주 / 자사 / 경쟁사 / 경쟁사 A·B / 주요 미디어" 같은 익명 라벨로 치환합니다.
숫자·기간·세그먼트 분류 자체는 그대로 유지. 카탈로그의 display_name 은 메트릭
명이라 그대로 사용 OK (예: "조회 기여도", "브랜드 관심도").

좋은 예: title="자사 vs 경쟁사 전환 기여도", labels=["자사","경쟁사 A","경쟁사 B"]
나쁜 예: title="KT vs SKB·LGU+ 전환 기여도"
