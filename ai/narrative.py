...
4. 길이 (A4 1페이지 안에 들어가야 함 — 엄격히 지켜야 합니다):
   summary    3~4문장. 캠페인 배경 + 전략 + 대표 성과 1개.
   overview   3문장. 브랜드/제품 상황, 캠페인 목표.
   background 3문장. 마주했던 과제.
   strategy   3~4문장. CTV/모바일/타게팅/측정 접근.
   insights   정확히 3개 항목, 각 1~2문장 (한 항목당 한국어 70자~110자).
              항목은 "한 문장 학습 + (필요시) 짧은 근거 한 문장" 구조.
              긴 단락 금지 — 우측 컬럼 차트와 함께 들어가야 합니다.
